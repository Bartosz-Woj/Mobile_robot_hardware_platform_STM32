...
/* Private defines -----------------------------------------------------------*/
#define KILL_PIN_Pin GPIO_PIN_13
#define KILL_PIN_GPIO_Port GPIOC
#define IR_Pin GPIO_PIN_14
#define IR_GPIO_Port GPIOC
#define STATUS_LED1_Pin GPIO_PIN_15
#define STATUS_LED1_GPIO_Port GPIOC
#define LED_SENSOR_PWM_Pin GPIO_PIN_6
#define LED_SENSOR_PWM_GPIO_Port GPIOA
#define STATUS_LED3_Pin GPIO_PIN_7
#define STATUS_LED3_GPIO_Port GPIOA
#define STATUS_LED2_Pin GPIO_PIN_4
#define STATUS_LED2_GPIO_Port GPIOC
#define V_VHK_Pin GPIO_PIN_2
#define V_VHK_GPIO_Port GPIOB
